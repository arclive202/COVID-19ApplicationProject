#PREVIOUSLY: WE TALKED ABOUT A LIVE GRAPH

#IN THIS WE ARE GOING TO DYNAMICALLY SELECT FIELDS DISPLAY GRAPHS AND MANY OTHER MULTIPLE THINGS
...
app = dash.Dash('vehicle-data',external_stylesheets=external_css,external_scripts=external_js)
max_length = 20
...
#We have the data dictionary that is going to map the options given in the drop down
#to the actual graph that has to be represented.
...
#THE NEXT BIT IS JUST FOR THE CREATION OF DUMMY DATA, SO FOR OUR PURPOSE WE CAN HAVE OUR OWN SOURCES FOR COLLECTING DATA
...
#NOW FOR DEFINING THE DECORATOR
...
#Now what we want to do is just add external CSS and Javascripts for our project
